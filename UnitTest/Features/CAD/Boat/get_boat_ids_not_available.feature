...
Scenario: Fechas que no tienen ordenes
	Given se piden los barcos reservados para las fechas <initialDate> y <endDate> y no hay reserva con esa fecha
...
Scenario: Fechas que tienen ordenes
	Given se piden los barcos reservados para las fechas <initialDate> y <endDate> y los barcos 1 y 2 estan reservados para esas fechas
	When se obtienen los barcos no disponibles
