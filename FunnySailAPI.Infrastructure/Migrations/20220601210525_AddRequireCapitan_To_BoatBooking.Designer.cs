...
namespace FunnySailAPI.Infrastructure.Migrations
{
    ...
    [Migration("20220601210525_AddRequireCapitan_To_BoatBooking")]
    partial class AddRequireCapitan_To_BoatBooking
    {
            ...
            modelBuilder.Entity("FunnySailAPI.ApplicationCore.Models.FunnySailEN.BoatEN", b =>
                {
                    ...
                    b.HasOne("FunnySailAPI.ApplicationCore.Models.FunnySailEN.MooringEN", "Mooring")
                        .WithOne("Boat")
                        .HasForeignKey("FunnySailAPI.ApplicationCore.Models.FunnySailEN.BoatEN", "MooringId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
